...
function reverseChart() {
    ...
    var chart = new CanvasJS.Chart("chartContainer",
    {
      ...
      title:{
      	text: "Mortality Rate versus Cause of Death", 
      ...
      {        
        ...
        dataPoints: [
        //Per 100,000 people
			{ label: "Cardiovascular Disease", y: 116.1},
			{ label: "Alzheimer's ", y:  25.1},
			{ label: "Cancer", y: 173.4 },
			{ label: "HIV/AIDS", y: 19.3 },
			{ label: "Pneumonia", y: 15.7 },
			{ label: "Road Traffic", y: 11.1 },
			{ label: "Suicide", y: 24.2 },
			]
      }
      ]
    });
    ...
    var chart = new CanvasJS.Chart("chartContainer",
    {
      ...
      {        
        ...
        //Per 100,000 people as of October 5, 2019
			{ label: "Cardiovascular Disease", y: 198.8},
			{ label: "Alzheimer's ", y:  68.7},
			{ label: "Cancer", y: 38.4 },
			{ label: "HIV/AIDS", y: 1.7 },
			{ label: "Pneumonia", y: 15.1 },
			{ label: "Road Traffic", y: 12.4 },
			{ label: "Suicide", y: 14.0 },
			]
		}
      ]
    });
...
var changeB=document.getElementById("changeBack");
changeB.addEventListener("click", reverseChart);
